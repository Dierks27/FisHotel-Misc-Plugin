<?php
/**
 * Announcer settings meta box — tabbed interface.
 *
...
$tabs = array(
	'general'    => __( 'General', 'fishotel-misc-plugin' ),
	'display'    => __( 'Display', 'fishotel-misc-plugin' ),
	'style'      => __( 'Style', 'fishotel-misc-plugin' ),
	'cta'        => __( 'CTA Buttons', 'fishotel-misc-plugin' ),
	'close'      => __( 'Close', 'fishotel-misc-plugin' ),
	'location'   => __( 'Location Rules', 'fishotel-misc-plugin' ),
	'visitor'    => __( 'Visitor Conditions', 'fishotel-misc-plugin' ),
	'multi'      => __( 'Multiple Messages', 'fishotel-misc-plugin' ),
	'countdown'  => __( 'Countdown Timer', 'fishotel-misc-plugin' ),
);
?>
...
<div class="ancr-meta-wrap">
	...
	<div class="ancr-tabs">
		<?php foreach ( $tabs as $id => $label ) : ?>
			<button type="button"
				class="ancr-tab <?php echo 'general' === $id ? 'ancr-tab--active' : ''; ?>"
	...
	<!-- GENERAL TAB                                                   -->
	<!-- ============================================================ -->
	<div class="ancr-panel" data-panel="general">

		<div class="ancr-field">
			<label class="ancr-label">
				<input type="checkbox" name="_announcer_enabled" value="1" <?php checked( $meta['_announcer_enabled'], '1' ); ?>>
				<?php esc_html_e( 'Enable this announcement', 'fishotel-misc-plugin' ); ?>
			</label>
		</div>
	...
	<!-- CTA BUTTONS TAB                                               -->
	<!-- ============================================================ -->
	<div class="ancr-panel" data-panel="cta" style="display:none;">

		<p class="ancr-desc"><?php esc_html_e( 'Add call-to-action buttons to your announcement.', 'fishotel-misc-plugin' ); ?></p>
				...
				foreach ( $cta_buttons as $i => $btn ) :
					...
					<div class="ancr-cta-item" data-index="<?php echo esc_attr( $i ); ?>">
						...
						<div class="ancr-cta-body">
							<div class="ancr-field-row">
								<div class="ancr-field">
									<label class="ancr-label"><?php esc_html_e( 'Text', 'fishotel-misc-plugin' ); ?></label>
									<input type="text" name="_announcer_cta_buttons[<?php echo esc_attr( $i ); ?>][text]" value="<?php echo esc_attr( $btn['text'] ); ?>">
								</div>
								<div class="ancr-field">
									<label class="ancr-label"><?php esc_html_e( 'Action', 'fishotel-misc-plugin' ); ?></label>
							...
							<div class="ancr-field-row">
								<div class="ancr-field">
									<label class="ancr-label"><?php esc_html_e( 'URL', 'fishotel-misc-plugin' ); ?></label>
									<input type="url" name="_announcer_cta_buttons[<?php echo esc_attr( $i ); ?>][url]" value="<?php echo esc_attr( $btn['url'] ?? '' ); ?>">
								</div>
								<div class="ancr-field">
									<label class="ancr-label"><?php esc_html_e( 'Target', 'fishotel-misc-plugin' ); ?></label>
							...
							<div class="ancr-field-row">
								<div class="ancr-field">
									<label class="ancr-label"><?php esc_html_e( 'Button bg', 'fishotel-misc-plugin' ); ?></label>
		...
		<button type="button" id="ancr-add-cta" class="button"><?php esc_html_e( '+ Add CTA Button', 'fishotel-misc-plugin' ); ?></button>
	...
	<div class="ancr-panel" data-panel="location" style="display:none;">
		...
		<div id="ancr-location-rules-wrap">
			...
			<button type="button" id="ancr-add-location-rule" class="button"><?php esc_html_e( '+ Add Rule', 'fishotel-misc-plugin' ); ?></button>
		</div>

	</div>

	<!-- ============================================================ -->
	<!-- VISITOR CONDITIONS TAB                                        -->
	<!-- ============================================================ -->
	<div class="ancr-panel" data-panel="visitor" style="display:none;">

		<p class="ancr-desc"><?php esc_html_e( 'Only show this announcement when ALL conditions below are met. Leave empty to show to everyone.', 'fishotel-misc-plugin' ); ?></p>
		...
		<button type="button" id="ancr-add-visitor-condition" class="button"><?php esc_html_e( '+ Add Condition', 'fishotel-misc-plugin' ); ?></button>

	</div>

	<!-- ============================================================ -->
	<!-- MULTIPLE MESSAGES TAB                                         -->
	<!-- ============================================================ -->
